...
struct MIDIRegression {
    static func main() throws {
        ...
        check(CoreMIDIManager.isNetworkSession("Network Session 1"), "Recognize system Network Session")
        check(CoreMIDIManager.isNetworkSession("Network Session 1 Input"), "Recognize decorated Network Session")
        check(!CoreMIDIManager.isNetworkSession("Yamaha P-125"), "Keep real MIDI device names")
